@echo off
REM Update crispz-qwen-edit (Windows): recupere les commits GitHub puis remet les
...
if errorlevel 1 (
    echo [ERROR] diffusers no longer ships the Qwen-Image pipelines.
