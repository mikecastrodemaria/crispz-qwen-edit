...
echo [4/5] diffusers...
!RUNPY! -c "from diffusers import QwenImagePipeline, QwenImageEditPlusPipeline; print('    Qwen-Image pipelines OK')" 2>nul
if errorlevel 1 echo    [WARNING] Qwen-Image pipelines unavailable -^> run install.bat / update.bat.
echo.
...
if defined EXPOSE (
    ...
    echo  crispz-qwen-edit has NO authentication and serves your output folder
...
echo ====================================================
echo    Checks OK. Starting crispz-qwen-edit...
echo ====================================================
